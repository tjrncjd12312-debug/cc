...
const PUBLIC_PATHS = ['/api/auth/login', '/api/auth/register', '/api/auth/check-referral', '/api/user/public-settings', '/api/user/notices', '/api/user/events', '/api/hl/my-info', '/api/game/aginfo'];
